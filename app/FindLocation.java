...
public class FindLocation extends AppCompatActivity
{
    ...
    protected  void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.location_acrivity);
        ...
        locationRequest.setInterval(60 * 1000); // how mutch you wount to update the location
    ...
    private void updateGPS() {
        ...
        //update UI
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(FindLocation.this);
    ...
    private void updateUI(Location location) {
        ...
        try {
            ...
            country=address.get(1).getCountryName();
